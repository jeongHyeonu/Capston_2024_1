        ...
        while (npc)
        {
            ...
            if (buttonPressed && !buttonPreviouslyPressed)
            {
                ...
                if (ScriptNum == 0)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_DESCRIPTION_1);
                }
                else if (ScriptNum == 1)
                {
                    Canvas.transform.localPosition = new Vector3(0f, 1f, 0f);
                    npc1.text = "시간이 없으니 사건부터 설명할게.\n집중해서 듣도록 해.";//보호복 착용 지시
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_DESCRIPTION_2);
                }
                else if (ScriptNum == 2)
                {
                    Canvas.transform.localPosition = new Vector3(0f, 1f, 0f);
                    npc1.text = "담당 경찰관의 보고에 의하면,\n오후 4시 15분경에 한 남성이 쓰러져있다는 신고가 들어왔다고 해.\n신고자는 남성의 가족으로 추정이 되고.";
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_DESCRIPTION_3);
                ...
                else if (ScriptNum == 3)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_DESCRIPTION_4);
                }
                else if (ScriptNum == 4)
                {
                    Canvas.transform.localPosition = new Vector3(0f, 1f, 0f);
                    npc1.text = "출동 직후 발견한 피해자는 의식이 없고\n왼쪽 머리에 둔기로 가격 당한 상처가 있었다고 하더라고.";//현장 NPC에게 확인받으라고 설명
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_DESCRIPTION_5);
                ...
                else if (ScriptNum == 5)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_DESCRIPTION_6);
                ...
                else if (ScriptNum == 6)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_DESCRIPTION_7);
                ...
                else if (ScriptNum == 7)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_PUT_ON_1);
                ...
                else if (ScriptNum == 8)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_PUT_ON_2);
                ...
                else if (ScriptNum == 9)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_PUT_ON_3);
                ...
                else if (ScriptNum == 11)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_UI_1);
                ...
                else if (ScriptNum == 12)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_UI_2);
                ...
                else if (ScriptNum == 13)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_UI_3);
                ...
                else if (ScriptNum == 14)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_UI_4);
                ...
                else if (ScriptNum == 15)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_UI_5);
                ...
                else if (ScriptNum == 16)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_HOW_1);
                ...
                else if (ScriptNum == 23) //0517 추가
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_HOW_8);
                }
                ...
                else if (ScriptNum == 24)
                {
                    ...
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_ORDER_1);
                }
                else if (ScriptNum == 25)
                {
                    Canvas.transform.localPosition = new Vector3(0f, 1f, 0f);
                    npc1.text = "다시 한번 말하지만, 사진 정말 중요해! \n지문 발견하면 사진! 지문이 검출되면 사진! 채취한 후에도 사진!";//현장 NPC에게 확인받으라고 설명
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_ORDER_2);
                }
                else if (ScriptNum == 26)
                {
                    Canvas.transform.localPosition = new Vector3(0f, 1f, 0f);
                    npc1.text = "실수 하나하나가 범인을 놓칠 수도 있다는 거 명심하도록!";//현장 NPC에게 확인받으라고 설명
                    SoundManager.Instance.PlayTTS(SoundManager.TTS_list.CRIME_ORDER_3);
                }
